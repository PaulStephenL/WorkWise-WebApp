  ...
  ***REMOVED***, [id]);
  ...
  async function fetchCompanyDetails() {
    try {
      ...
      const { data: jobsData, error: jobsError ***REMOVED*** = await supabase
        .from('jobs')
        .select(`
          id,
          title,
    ...
    return (
      <div className="container mx-auto p-4 max-w-5xl">
        <div className="bg-red-50 text-red-600 p-4 rounded-md">
          {error || 'Company not found'***REMOVED***
        </div>
      </div>
    );
  ***REMOVED***
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
        <div className="flex items-start space-x-6">
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold mb-2">{company.name***REMOVED***</h1>
            <div className="flex items-center text-gray-600 mb-4">
              ...
              {company.location || 'Location not specified'***REMOVED***
            </div>
            <p className="text-gray-600">{company.description || 'No description available'***REMOVED***</p>
          </div>
        </div>
      </div>
            ...
            {jobs.map((job) => (
              ...
              >
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="text-xl font-semibold mb-2">{job.title***REMOVED***</h3>
                    ...
                    <p className="text-gray-600 line-clamp-2">{job.description***REMOVED***</p>
                  </div>
